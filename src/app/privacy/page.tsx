      ...
      <div className="card space-y-5 p-6 text-sm leading-relaxed text-slate-700">
        ...
        <section>
          ...
          <ul className="list-inside list-disc space-y-1">
            ...
            <li>To understand usage and improve the product during the pilot.</li>
          </ul>
        </section>

        <section>
          <h2 className="mb-1 font-bold text-slate-900">3. Processing &amp; third parties</h2>
          <p>
        ...
        <section>
          <h2 className="mb-1 font-bold text-slate-900">4. WhatsApp feedback group</h2>
          <p>
        ...
        <section>
          <h2 className="mb-1 font-bold text-slate-900">5. Retention</h2>
          <p>
        ...
        <section>
          <h2 className="mb-1 font-bold text-slate-900">6. Your rights (PDPA)</h2>
          <p>
        ...
        <section>
          <h2 className="mb-1 font-bold text-slate-900">7. Security</h2>
          <p>
        ...
        <section>
          <h2 className="mb-1 font-bold text-slate-900">8. Contact</h2>

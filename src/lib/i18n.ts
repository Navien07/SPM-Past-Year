...
export const STRINGS: Dict = {
  ...
  "qlist.back": { en: "Back to list", bm: "Kembali ke senarai" },
  "qlist.backTopics": { en: "Back to topics", bm: "Kembali ke topik" },
  "qlist.todo": { en: "To do", bm: "Untuk dibuat" },
  "qlist.completed": { en: "Completed", bm: "Selesai" },
  "qlist.all": { en: "All papers", bm: "Semua kertas" },
  "qd.prev": { en: "Previous", bm: "Sebelumnya" },
  "qd.next": { en: "Next question", bm: "Soalan seterusnya" },
